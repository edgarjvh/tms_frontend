                    ...
                    <div className="page-block" style={{ paddingTop: '2rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gridGap: '1rem' }}>
                        ...
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{
                                ...
                                {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                    ? <span style={{ ...this.styleFieldDataBold }}>{((this.props.selectedCustomer.mailing_address?.bill_to_contact.code_number || 0) === 0 ? (this.props.selectedCustomer.mailing_address?.bill_to_contact.code || '') : this.props.selectedCustomer.mailing_address?.bill_to_contact.code + this.props.selectedCustomer.mailing_address?.bill_to_contact.code_number).toUpperCase()}</span>
                                    : <span style={{ ...this.styleFieldDataBold }}>{((this.props.selectedCustomer.mailing_address?.code_number || 0) === 0 ? (this.props.selectedCustomer.mailing_address?.code || '') : this.props.selectedCustomer.mailing_address?.code + this.props.selectedCustomer.mailing_address?.code_number).toUpperCase()}</span>
                                }
                            </div>
                            ...
                            <div style={{
                                ...
                                {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                    ? <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.bill_to_contact.name}</span>
                                    : <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.name}</span>
                                }
                            </div>
                            ...
                            <div style={{
                                ...
                                {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                    ? <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.bill_to_contact.address1}</span>
                                    : <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.address1}</span>
                                }
                            </div>
                            ...
                            <div style={{
                                ...
                                {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                    ? <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.bill_to_contact.address2}</span>
                                    : <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.address2}</span>
                                }
                            </div>
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                        ? <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.bill_to_contact.city}</span>
                                        : <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.city}</span>
                                    }
                                </div>
                                ...
                                <div style={{
                                    ...
                                    {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                        ? <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.bill_to_contact.state}</span>
                                        : <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.state}</span>
                                    }
                                </div>
                                ...
                                <div style={{
                                    ...
                                    {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                        ? <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.bill_to_contact.zip}</span>
                                        : <span style={{ ...this.styleFieldDataBold }}>{this.props.selectedCustomer.mailing_address?.zip}</span>
                                    }
                                </div>
                            </div>
                            ...
                            <div style={{
                                ...
                                {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                    ? <span style={{ ...this.styleFieldDataBold }}>{
                                        ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.first_name || '') +
                                        ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || [].find(c => c.is_primary === 1)?.last_name || '') === ''
                                            ? ''
                                            : ' ' + (this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.last_name)
                                    }</span>
                                    : <span style={{ ...this.styleFieldDataBold }}>{
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                        ?
                                        <span style={{ ...this.styleFieldDataBold }}>{
                                            ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.primary_phone || '') === 'work'
                                                ? ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.phone_work || '')
                                                : ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.primary_phone || '') === 'fax'
                                                    ? ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.phone_work_fax || '')
                                                    : ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.primary_phone || '') === 'mobile'
                                                        ? ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.phone_mobile || '')
                                                        : ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.primary_phone || '') === 'direct'
                                                            ? ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.phone_direct || '')
                                                            : ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.primary_phone || '') === 'other'
                                                                ? ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.phone_other || '')
                                                                : ''
                                        }</span>
                                ...
                                <div style={{
                                    ...
                                    {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                        ? <span style={{ ...this.styleFieldDataBold }}>{
                                            ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.phone_ext || '')
                                        }</span>
                                        : <span style={{ ...this.styleFieldDataBold }}>{
                            ...
                            <div style={{
                                ...
                                {this.props.selectedCustomer.mailing_address?.bill_to_contact
                                    ? <span style={{ ...this.styleFieldDataBold }}>{
                                        ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.primary_email || '') === 'work'
                                            ? ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.email_work || '')
                                            : ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.primary_email || '') === 'personal'
                                                ? ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.email_personal || '')
                                                : ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.primary_email || '') === 'other'
                                                    ? ((this.props.selectedCustomer?.mailing_address?.bill_to_contact.contacts || []).find(c => c.is_primary === 1)?.email_other || '')
                                                    : ''
                                    }</span>
