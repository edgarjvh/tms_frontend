...
function Company(props) {
    ...
    const customersTPanelTransition = useTransition(props.customersTPanels, {
        from: panel => {
            return {
                width: `calc(${baseWidth}% - ${panelGap * (props.customersTPanels.findIndex(p => p?.panelName === (panel?.panelName || '')))}px)`,
                right: `calc(-100%)`,
            }
        },
        enter: panel => {
