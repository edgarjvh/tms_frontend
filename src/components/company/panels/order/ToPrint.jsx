                ...
                <div className="container-sheet">
                    ...
                    <div className="page-block" style={{ paddingTop: '1.5rem' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'center' }}>
                                <div style={{ marginBottom: 5 }}><span style={{ ...this.styleFieldName, fontSize: '0.9rem', marginRight: 10 }}>ORDER#</span> <span style={{ ...this.styleFieldData, fontSize: '0.9rem' }}>{this.props.selectedOrder?.order_number}</span></div>
                                <div><span style={{ ...this.styleFieldName, fontSize: '0.9rem', marginRight: 10 }}>TRIP#</span> <span style={{ ...this.styleFieldData, fontSize: '0.9rem' }}>{this.props.selectedOrder?.trip_number}</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="page-block" style={{ paddingTop: '1.5rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gridGap: '1rem' }}>
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{
                                ...
                                <span style={{ ...this.styleFieldName, marginRight: 10 }}>CODE:</span> <span style={{ ...this.styleFieldDataBold }}>{((this.props.selectedOrder?.bill_to_company?.code_number || 0) === 0 ? (this.props.selectedOrder?.bill_to_company?.code || '') : this.props.selectedOrder?.bill_to_company?.code + this.props.selectedOrder?.bill_to_company?.code_number).toUpperCase()}</span>
                            </div>
                            ...
                            <div style={{
                                ...
                                <span style={{ ...this.styleFieldName, marginRight: 10 }}>NAME:</span> <span style={{ ...this.styleFieldDataBold }}>{(this.props.selectedOrder?.bill_to_company?.name || '')}</span>
                            </div>
                            ...
                            <div style={{
                                ...
                                <span style={{ ...this.styleFieldName, marginRight: 10 }}>ADDRESS 1:</span> <span style={{ ...this.styleFieldDataBold }}>{(this.props.selectedOrder?.bill_to_company?.address1 || '')}</span>
                            </div>
                            ...
                            <div style={{
                                ...
                                <span style={{ ...this.styleFieldName, marginRight: 10 }}>ADDRESS 2:</span> <span style={{ ...this.styleFieldDataBold }}>{(this.props.selectedOrder?.bill_to_company?.address2 || '')}</span>
                            </div>
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <span style={{ ...this.styleFieldName, marginRight: 10 }}>CITY:</span> <span style={{ ...this.styleFieldDataBold }}>{(this.props.selectedOrder?.bill_to_company?.city || '')}</span>
                                </div>

                                <div style={{
                                    ...this.styleFlexRow
                                }}>
                                    <span style={{ ...this.styleFieldName, marginRight: 10 }}>STATE:</span> <span style={{ ...this.styleFieldDataBold }}>{(this.props.selectedOrder?.bill_to_company?.state || '')}</span>
                                </div>

                                <div style={{
                                    ...this.styleFlexRow
                                }}>
                                    <span style={{ ...this.styleFieldName, marginRight: 10 }}>ZIP:</span> <span style={{ ...this.styleFieldDataBold }}>{(this.props.selectedOrder?.bill_to_company?.zip || '')}</span>
                                </div>
                            </div>
                        ...
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            <div style={{
                                ...
                                <div style={{ ...this.styleFlexRow }}><span style={{ ...this.styleFieldName, marginRight: 5 }}>DIVISION:</span> <span style={{ ...this.styleFieldDataBold }}>{(this.props.selectedOrder?.division?.name || '')}</span></div>
                                ...
                                <div style={{ ...this.styleFlexRow }}><span style={{ ...this.styleFieldName, marginRight: 5 }}>LOAD TYPE:</span> <span style={{ ...this.styleFieldDataBold }}>{(this.props.selectedOrder?.load_type?.name || '')}</span></div>
                                ...
                                <div style={{ ...this.styleFlexRow }}><span style={{ ...this.styleFieldName, marginRight: 5 }}>TOTAL CHARGES:</span>
                                    <NumberFormat
                        ...
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ ...this.styleFlexRow, justifyContent: 'space-evenly', marginBottom: 15 }}>
                                    <div style={{ ...this.styleFlexRow }}><span style={{ ...this.styleFieldName, marginRight: 5 }}>EQUIPMENT:</span> <span style={{ ...this.styleFieldData }}>{(this.props.selectedOrder?.equipment?.name || '').toUpperCase()}</span></div>
                                    <div style={{ ...this.styleFlexRow }}><span style={{ ...this.styleFieldName, marginRight: 5 }}>EXPEDITED:</span> <span style={{ ...this.styleFieldData }}>{this.props.selectedOrder?.expedited === 1 ? 'YES' : 'NO'}</span></div>
                                    <div style={{ ...this.styleFlexRow }}><span style={{ ...this.styleFieldName, marginRight: 5 }}>HAZ-MAT:</span> <span style={{ ...this.styleFieldData }}>{this.props.selectedOrder?.haz_mat === 1 ? 'YES' : 'NO'}</span></div>
                                </div>

                                {
                                    (this.props.selectedOrder?.order_customer_ratings || []).length > 0 &&
                                    <div style={{ display: 'grid', gridTemplateColumns: '5rem 5rem 1fr 7rem', marginBottom: 7 }}>
                                        {
                                            ...
                                            <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Pieces/Skids</span>
                                        }

                                        {
                                            ((this.props.selectedOrder?.order_customer_ratings || []).find(r => (r.rate_type?.name || '').toLowerCase() === 'flat') !== undefined ||
                                                (this.props.selectedOrder?.order_customer_ratings || []).find(r => (r.rate_type?.name || '').toLowerCase() === 'linehaul') !== undefined) &&
                                            <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Weight</span>
                                        }

                                        <span style={{ ...this.styleFieldName, textDecoration: 'underline', paddingLeft: 8 }}>Description</span>

                                        <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'right' }}>Charges</span>
                                            ...
                                            <div style={{
                                            ...
                                            }} key={index}>
                                                {
                                                    ((this.props.selectedOrder?.order_customer_ratings || []).find(r => (r.rate_type?.name || '').toLowerCase() === 'flat') !== undefined ||
                                                        (this.props.selectedOrder?.order_customer_ratings || []).find(r => (r.rate_type?.name || '').toLowerCase() === 'linehaul') !== undefined) &&
                                                    <NumberFormat
                                                        style={{ ...this.styleFieldData, color: '#4682B4', fontWeight: 'bold', textAlign: 'center' }}
                                                ...
                                                <span style={{ ...this.styleFieldData, color: '#4682B4', fontWeight: 'bold', paddingLeft: 8 }}>{rating.description}</span>

                                                <div style={{ ...this.styleFieldData, textAlign: 'right', color: '#4682B4', fontWeight: 'bold' }}>
                                                    <NumberFormat
                    ...
                    <div className="page-block" style={{ paddingTop: '1.5rem', display: 'grid', gridTemplateColumns: '3fr 2fr', gridGap: '1rem' }}>
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ ...this.styleFlexCol, justifyContent: 'center', flexGrow: 1, flexBasis: '100%' }}>
                                    ...
                                    <span style={{ ...this.styleFieldData, marginBottom: 5 }}>{(this.props.selectedOrder?.carrier?.name || '')}</span>
                                    <span style={{ ...this.styleFieldData, marginBottom: 5 }}>{(this.props.selectedOrder?.carrier?.address1 || '')}</span>
                                    <span style={{ ...this.styleFieldData }}>{(this.props.selectedOrder?.carrier?.city || '')}, {(this.props.selectedOrder?.carrier?.state || '').toUpperCase()} {(this.props.selectedOrder?.carrier?.zip || '')}</span>
                                </div>
                        ...
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{ ...this.styleFlexCol, justifyContent: 'center', flexGrow: 1, flexBasis: '100%' }}>
                                <div style={{ ...this.styleFlexRow, marginBottom: 5 }}><span style={{ ...this.styleFieldName, width: '4rem' }}>NAME:</span> <span style={{ ...this.styleFieldData }}>{(this.props.selectedOrder?.driver?.first_name || '').toUpperCase()} {(this.props.selectedOrder?.driver?.last_name || '').toUpperCase()}</span></div>
                                <div style={{ ...this.styleFlexRow, marginBottom: 5 }}><span style={{ ...this.styleFieldName, width: '4rem' }}>PHONE:</span> <span style={{ ...this.styleFieldData }}>{(this.props.selectedOrder?.driver?.phone || '').toUpperCase()}</span></div>
                                <div style={{ ...this.styleFlexRow, marginBottom: 5 }}><span style={{ ...this.styleFieldName, width: '4rem' }}>UNIT:</span> <span style={{ ...this.styleFieldData }}>{(this.props.selectedOrder?.driver?.truck || '').toUpperCase()}</span></div>
                                <div style={{ ...this.styleFlexRow, marginBottom: 5 }}><span style={{ ...this.styleFieldName, width: '4rem' }}>TRAILER:</span> <span style={{ ...this.styleFieldData }}>{(this.props.selectedOrder?.driver?.trailer || '').toUpperCase()}</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="page-block" style={{ paddingTop: '1.5rem', display: 'grid', gridTemplateColumns: '1fr' }}>
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{ ...this.styleFlexRow, justifyContent: 'space-between', marginBottom: 10 }}>
                                ...
                                <span style={{ ...this.styleFieldName, minWidth: '12rem', maxWidth: '12rem', textDecoration: 'underline' }}>Event</span>
                                ...
                                this.props.selectedOrder?.events.map((item, index) => {
                                    return (
                                        <div key={index} style={{ ...this.styleFlexRow, justifyContent: 'space-between', marginBottom: 5 }}>
                                            ...
                                            <span style={{ ...this.styleFieldData, minWidth: '12rem', maxWidth: '12rem' }}>{(item.event_type?.name || '').toUpperCase()}</span>
                    ...
                    <div className="page-block" style={{ paddingTop: '1.5rem', paddingBottom: '1.5rem', display: 'grid', gridTemplateColumns: '1fr' }}>
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{ ...this.styleFlexRow, marginBottom: 10, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr 1fr 1fr 1fr' }}>
                                <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Pieces/Skids</span>
                                <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Weight</span>
                                <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Charges</span>
                                <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Order Cost</span>
                                <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Profit</span>
                                <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Percentage</span>
                                <span style={{ ...this.styleFieldName, textDecoration: 'underline', textAlign: 'center' }}>Miles</span>
                            </div>

                            <div style={{ ...this.styleFlexRow, marginBottom: 10, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr 1fr 1fr 1fr' }}>
                                {/* PIECES-SKIDS */}
                                <NumberFormat
                                    style={{ ...this.styleFieldData, textAlign: 'center', fontWeight: 'bold', color: '#4682B4' }}
                                    value={
                                        // new Intl.NumberFormat('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(Number(((this.props.selectedOrder?.order_customer_ratings || []).reduce((a, b) => {
                                ...
                                <NumberFormat
                                    style={{ ...this.styleFieldData, textAlign: 'center', fontWeight: 'bold', color: '#4682B4' }}
                                    value={
                                        new Intl.NumberFormat('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(Number(((this.props.selectedOrder?.order_carrier_ratings || []).reduce((a, b) => {
                                            return { total_charges: Number(a.total_charges) + Number(b.total_charges) }
                                        }, { total_charges: '' })?.total_charges || '').toString().replace(',', '')))
                                    }
                                    thousandsGroupStyle="thousand"
                                ...
                                <NumberFormat
                                    style={{
                                        ...this.styleFieldData, textAlign: 'center', fontWeight: 'bold', color: Number(((this.props.selectedOrder?.order_customer_ratings || []).reduce((a, b) => {
