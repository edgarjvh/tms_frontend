...
const Documents = (props) => {
    ...
    const tagsOnKeydown = (e) => {
        ...
        if (keyCode === 13) {
            setSelectedOwnerDocument({ ...selectedOwnerDocument, tags: (selectedOwnerDocument.tags || '') === '' ? selectedOwnerDocumentTags : selectedOwnerDocument.tags + '|' + selectedOwnerDocumentTags });
            ...
            <div className="documents-fields">
                <div className="documents-left-side">
                    <div className="documents-fields-row">
                        ...
                        <div className="input-box-container" style={{ marginRight: 5 }}>
                            <input type="text" placeholder="Date Entered" readOnly={true} value={selectedOwnerDocument.date_entered || moment().format('MM/DD/YYYY')} />
                        </div>
                    ...
                    <div className="documents-fields-row">
                        <div className="input-box-container">
                            <input
                                ...
                                onChange={(e) => { setSelectedOwnerDocument({ ...selectedOwnerDocument, title: e.target.value }) }}
                        ...
                        <div className="input-box-container">
                            <input
                                ...
                                onChange={(e) => { setSelectedOwnerDocument({ ...selectedOwnerDocument, subject: e.target.value }) }}
                                readOnly={(selectedOwnerDocument.id || 0) > 0} />
                        </div>
                        ...
                        <div className="input-box-container tags" style={{
                                            ...
                                            <div key={index} style={{
                                            ...
                                            }} title={item}>
                                                {
                                                    ...
                                                    <span className="fas fa-trash-alt" style={{ marginRight: '5px', cursor: 'pointer' }}
                                                        onClick={() => {
                                                            setSelectedOwnerDocument({ ...selectedOwnerDocument, tags: (selectedOwnerDocument.tags || '').replace(item, '').trim() })
                                                        }}></span>
                                                }
                            ...
                            <input type="text" placeholder="Tags" ref={refTagInput}
                                ...
                                onChange={(e) => { setSelectedOwnerDocumentTags(e.target.value) }}
                                onInput={(e) => { setSelectedOwnerDocumentTags(e.target.value) }}
                                readOnly={(selectedOwnerDocument.id || 0) > 0} />
                        </div>
                    </div>
                </div>
                ...
                <div className="documents-right-side">
                    ...
                    <div className="mochi-button" style={{
                        ...
                        <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                        <div className="mochi-button-base" style={{ color: (selectedOwnerDocument.id || 0) > 0 ? 'rgba(0,0,0,0.3)' : '#323232' }}>Upload Documents</div>
                        <div className="mochi-button-decorator mochi-button-decorator-right">)</div>
                    </div>
                                                ...
                                                if (window.confirm('Are you sure to delete this document?')) {
                                                    ...
                                                    axios.post(props.serverUrl + deletingDocumentUrl, {
                                                        ...
                                                        if (res.data.result === 'OK') {
                                                            ...
                                                            if (props.suborigin === 'order-billing') {
                                                                setSelectedOwner(selectedOwner => {
                                                                    return { ...selectedOwner, billing_documents: res.data.documents }
                                                                })
                        ...
                        <div className="form-buttons">
                            <div className="mochi-button" onClick={() => {
                                if ((selectedOwnerDocument.id || 0) > 0) {
                                    setSelectedOwnerDocumentNote({ id: 0, customer_document_id: selectedOwnerDocument.id })
                                } else {
                                ...
                                <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                <div className="mochi-button-base" style={{ color: (selectedOwnerDocument.id || 0) > 0 ? '#323232' : 'rgba(0,0,0,0.3)' }}>Add Note</div>
                                <div className="mochi-button-decorator mochi-button-decorator-right">)</div>
                            </div>
                        </div>
                        <div className="top-border top-border-right"></div>
            ...
            <div className="documents-preview">
                <div className="form-bordered-box">
...

                    {
                        ...
                        <iframe id="frame-preview" src={(props.serverUrl + serverDocumentsFolder + selectedOwnerDocument.doc_id) + '#toolbar=1&navpanes=0&scrollbar=0'} frameBorder={0} allowFullScreen={true} width="100%" height="100%"></iframe>
                    }
...

                    {
                        ...
                        <iframe id="frame-preview" src={('https://view.officeapps.live.com/op/embed.aspx?src=' + props.serverUrl + serverDocumentsFolder + selectedOwnerDocument.doc_id) + '#toolbar=1&navpanes=0&scrollbar=0'} frameBorder={0} allowFullScreen={true} width="100%" height="100%"></iframe>
                    }
...

                    {
                        ...
                        <div className="preview-not-available">
                            <span>No preview available for this file</span> <a href={props.serverUrl + serverDocumentsFolder + selectedOwnerDocument.doc_id} download={true}>Download</a>
                        </div>
                    }
                </div>
            </div>
