...
const FactoringCompanySearch = (props) => {
    const refFactoringCompanySearchContainer = useRef();
    ...
    useEffect(() => {
        refFactoringCompanySearchContainer.current.focus({
            preventScroll: true
        })
    }, []);
    ...
    return (
        <div className="panel-content" tabIndex={0} ref={refFactoringCompanySearchContainer} onKeyDown={e => {
            if (e.key === 'Escape') {
