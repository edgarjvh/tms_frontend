        ...
        <div className="container-sheet">
          ...
          <div className="page-block" style={{ paddingTop: "2rem" }}>
            ...
            >
              ...
              <span style={{ ...this.styleFieldDataBold }}>
                {(this.props.selectedCarrierInfoContact?.primary_email ||
                  "work") === "work"
            ...
            >
              ...
              <NumberFormat
                ...
                value={Number(
                  (
                    (
                      this.props.selected_order?.order_carrier_ratings || []
                    ).reduce(
                      (a, b) => {
                        return {
                          total_charges:
          ...
          {(this.props.selected_order?.routing || []).map((route, index) => {
            let pickup =
              route.type === "pickup"
                ? (this.props.selected_order?.pickups || []).find(
                    (p) => p.id === route.pickup_id
                  )
                : {};
            let delivery =
              route.type === "delivery"
                ? (this.props.selected_order?.deliveries || []).find(
                    (d) => d.id === route.delivery_id
                  )
                : {};
            let customer =
              route.type === "pickup" ? pickup.customer : delivery.customer;
                      ...
                      <div style={{ ...this.styleFieldData }}>
                        {(customer?.contacts || []).find(
                          ...
                          : (customer.contacts.find((c) => c.is_primary === 1)
                              .primary_phone || "work") === "work"
                          ? customer.contacts.find((c) => c.is_primary === 1)
                              .phone_work
                          : (customer.contacts.find((c) => c.is_primary === 1)
                              .primary_phone || "work") === "fax"
                          ? customer.contacts.find((c) => c.is_primary === 1)
                              .phone_work_fax
                          : (customer.contacts.find((c) => c.is_primary === 1)
                              .primary_phone || "work") === "mobile"
                          ? customer.contacts.find((c) => c.is_primary === 1)
                              .phone_mobile
                          : (customer.contacts.find((c) => c.is_primary === 1)
                              .primary_phone || "work") === "direct"
                          ? customer.contacts.find((c) => c.is_primary === 1)
                              .phone_direct
                          : (customer.contacts.find((c) => c.is_primary === 1)
                              .primary_phone || "work") === "other"
                          ? customer.contacts.find((c) => c.is_primary === 1)
                              .phone_other
                          : ""}
                      </div>
          ...
          {/* PAGE BLOCK */}
          {((this.props.selected_order?.order_carrier_ratings || []).find(
            (r) => (r.rate_type?.name || "").toLowerCase() === "linehaul"
          ) !== undefined ||
            (this.props.selected_order?.order_carrier_ratings || []).find(
              (r) => (r.rate_type?.name || "").toLowerCase() === "flat"
            ) !== undefined) && (
            <div className="page-block" style={{ paddingTop: "2rem" }}>
              <div
                style={{
              ...
              >
                ...
                {(this.props.selected_order.order_carrier_ratings || []).map(
                  (rating, index) => {
                    if (
                      (rating.rate_type?.name || "").toLowerCase() ===
                        "linehaul" ||
                      (rating.rate_type?.name || "").toLowerCase() === "flat"
                    ) {
                      return (
                        <div
                          key={index}
                        ...
                        >
                          ...
                          >
                            <NumberFormat
                              ...
                              thousandSeparator={true}
                              decimalScale={
                                Number.isInteger(rating.pieces) ? 0 : 2
                              }
                              fixedDecimalScale={true}
                              prefix={""}
                              suffix={
                          ...
                          >
                            <NumberFormat
                              ...
                              thousandSeparator={true}
                              decimalScale={
                                Number.isInteger(rating.weight) ? 0 : 2
                              }
                              fixedDecimalScale={true}
                              prefix={""}
                              type="text"
              ...
              {(this.props.selected_order?.notes_for_carrier || []).map(
                (note, index) => {
                  return (
                    <div
                      key={index}
...
of lading and signed delivery receipts, completed W-9
        ...
        <div className="container-sheet">
          ...
          >
            ...
            {(this.props.selected_order?.notes_for_driver || []).map(
              (note, index) => {
                return (
                  <div
                    key={index}
